...
public class GenerateNewClassByJavassist {
    ...
    public static void main(String[] args) throws Exception{
        ...
        CtClass ctClass = pool.makeClass("love.celery.javassit.Emp");
        //添加字段
        ...
        FileOutputStream fos = new FileOutputStream(new File("D://object//Emp.class"));
        fos.write(byteArr);
        fos.close();
    }
}