...
public class CuratorClient {
    ...
    public static final String REGISTRY_ADDRESS="slc11fsp.us.oracle.com:2181";

    public static void main(String[] args) throws Exception
    {
        CuratorFramework client = CuratorFrameworkFactory.newClient(REGISTRY_ADDRESS, new RetryNTimes(10, 5000));
        client.start();// 连接
        // 获取子节点，顺便监控子节点
