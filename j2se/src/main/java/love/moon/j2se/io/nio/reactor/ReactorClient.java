package love.moon.j2se.io.nio.reactor;

import love.moon.j2se.io.nio.AbstractConfig;
...
import static love.moon.j2se.io.nio.reactor.Reactor.PORT;
...
public class ReactorClient extends AbstractConfig {
    ...
    protected void sendMsg(SocketChannel sc) throws IOException {
        ...
        String sendText = Thread.currentThread().getName() + "-"  + " \r\n";
