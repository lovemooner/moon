...
public class MyThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public static ExecutorService newFixedThreadPool(int nThreads, String poolName) {
        return new MyThreadPoolExecutor(nThreads, nThreads, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(), poolName);
    }
    ...
    public static ExecutorService newCachedThreadPool(String poolName) {
        return new MyThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<>(), poolName);
    }
