 ...
 * Date: 2017/6/1 15:36
 */
public class BalanceTree<Key extends Comparable<Key>, Value>  {
    ...
    public Value get(Key key) { return search(root, key, height); }
    ...
    public static void main(String[] args) {
        BalanceTree<String, String> st = new BalanceTree<String, String>();
